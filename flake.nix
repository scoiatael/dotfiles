{
  ...
  in {
    homeConfigurations."lukaszczaplinski@LsFramework" = home-manager.lib.homeManagerConfiguration {
    ...
    homeConfigurations."lucasczaplinski@LsCerosDarwin" = home-manager.lib.homeManagerConfiguration {
      pkgs = import nixpkgs {
    ...
    homeConfigurations."lukaszczaplinski@LsGamingDarwin" = home-manager.lib.homeManagerConfiguration {
    ...
    homeConfigurations."lukaszczaplinski@LsAir" = home-manager.lib.homeManagerConfiguration {
      pkgs = import nixpkgs {
        system = "aarch64-darwin";
        config.allowBroken = true;
      };
