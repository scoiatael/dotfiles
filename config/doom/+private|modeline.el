;;; +private|modeline.el -*- lexical-binding: t; no-byte-compile: t; -*-
...
;;;; Segments, me own
             ...
             ;; (defun +private|modeline/set-documentation-modeline ()
             ;;   ""
             ;;   (doom-modeline-set-modeline 'documentation)
             ...
             (defun +private/adjust-modeline ()
               (when (string-match "private" (format! "%s" doom-theme))
                 ...
                 ;;    (set-face-attribute 'header-line-inactive nil :family "Operator Mono")
