...
scale = 2
clock_offset_x = 400*scale
clock_offset_y = 80*scale

stats_offset_x = 150*scale
stats_offset_y = 35*scale
stats_offset_y_between = 75*scale
stats_fg_colour = 0xFFFFFF
stats_bg_colour = 0xFFFFFF
...
clock_h = {
    ...
    txt_radius=70*scale,
    txt_weight=0,                  txt_size=11.0*scale,
...
clock_m = {
    ...
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.3,
    txt_radius=34*scale,
    txt_weight=1,                  txt_size=10.0*scale,
    txt_fg_colour=0xFFFFFF,        txt_fg_alpha=0.6,
...
gauge = {
{
    ...
    graph_bg_colour=stats_bg_colour,      graph_bg_alpha=0.1,
    graph_fg_colour=stats_fg_colour,      graph_fg_alpha=0.5,
    hand_fg_colour=0xEF5A29,       hand_fg_alpha=0.0,
    txt_radius=34*scale,
    txt_weight=0,                  txt_size=8.0*scale,
    txt_fg_colour=stats_fg_colour,        txt_fg_alpha=0.3,
    graduation_radius=28,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=27,
    graduation_fg_colour=stats_fg_colour, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=8.0,
    caption_fg_colour=stats_fg_colour,    caption_fg_alpha=0.3,
},
{
...
},
{
    ...
    x=clock_offset_x+stats_offset_x,                            y=stats_offset_y+stats_offset_y_between,
    graph_radius=24*scale,
    graph_thickness=5*scale,
    graph_start_angle=180,
    ...
    txt_weight=0,                  txt_size=8.0*scale,
    txt_fg_colour=stats_fg_colour,        txt_fg_alpha=0.3,
    graduation_radius=17*scale,
    graduation_thickness=8,        graduation_mark_thickness=2,
    graduation_unit_angle=27,
    graduation_fg_colour=stats_fg_colour, graduation_fg_alpha=0.5,
    caption='',
    caption_weight=1,              caption_size=8.0,
    caption_fg_colour=stats_fg_colour,    caption_fg_alpha=0.3,
},
